...
public enum GameMap {
	...
	TEITAKU("Teitaku", "HIDE_Teitaku", new SpawnLocation("HIDE_Teitaku", -192.5, 12, 429.5, -90.1f, 0.1f), new SpawnLocation("HIDE_Teitaku", -160.5, 12, 447.5, 90.1f, 0.1f)),
	...
	HUMBUG("Humbug St.", "HIDE_Humbug", new SpawnLocation("HIDE_Humbug", 29.5, 6.5, 52.5, 135.1f, 0.1f), new SpawnLocation("HIDE_Humbug", 29.5, 20, 68.5, 180.1f, 0.0f)),
